/*
 ...
 Version 1.1.1 is designed to work with a Printed Circuit Board (PCB) that mounts directly on top of the
 Arduino Uno as a shield and fixes two issues: a maximum flow rate is read as 0 uL/min and if the 
 microcontroller fails to connect to the flow meter it opens up the EPC to full pressure.
 */
...
const int DEFAULT_FLOW_RATE = 400;
...
const long DELAY = 2000; // milliseconds
