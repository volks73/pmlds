...
int flowRateQueue[FLOW_RATE_QUEUE_SIZE];
...
void loop()
{
  ...
  if ( flowMeterConnected )
  {
    ...
    if ( (currentTime - lastUpdate) > updateDelay )
    {
      ...
      updateScreenFlowRate(averageFlowRate, ACTUAL_FLOW_RATE_ROW);
      ...
      if ( purgeActivated )
      {
        ...
        // At the end of the purge, reduce the pressure and reach a lower stable flow.
      ...
      if ( pidActivated )
      {
        ...
        float pidActual = float(averageFlowRate) / 10.0;
